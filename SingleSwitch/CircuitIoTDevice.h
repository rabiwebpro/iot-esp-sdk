...
#include <functional>
#define DEVICE_CALLBACK_SIGNATURE std::function<void(const char*, const char*)> deviceCallback
#else
#define DEVICE_CALLBACK_SIGNATURE void (*deviceCallback)(const char*, const char*)
#endif
